...

{
    ...
    NSMutableArray *mutableJoinedArray = [NSMutableArray arrayWithArray:arrayOne];
    
    
    
    [mutableJoinedArray addObjectsFromArray:arrayTwo];
    
    
    
    return mutableJoinedArray;
...

{
    ...
    NSDictionary *images = lastObject[@"images"];
    
    
    
    NSDictionary *standard_resolution = images[@"standard_resolution"];
    
    NSString *urlString = standard_resolution[@"url"];

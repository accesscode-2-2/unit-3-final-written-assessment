...
{
    NSArray * myArray = @[@"dinosaur", @"catfish", @"spoon", @123, @[]];
    return myArray;
}
...
{
    NSString *object = [dictionary objectForKey:@"mountain"];
    return object;
}
...
- (id)createAnEwokAndDoSomeStuffWithIt
{
    Ewok *babyEwok = [[Ewok alloc]init];
    [babyEwok setName:@"Carl"];
    [babyEwok walk:8];
    [babyEwok feed];

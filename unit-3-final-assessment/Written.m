...
{
    NSString *fifthItem = [theArray objectAtIndex:4];
    return fifthItem;
}
             ...
             withArrayTwo:(NSArray *)arrayTwo
{
    ...
    NSArray *array = [arrayOne arrayByAddingObjectsFromArray:arrayTwo];
    return array;
}
...
{
    NSString *mount = [dictionary objectForKey:@"mountain"];
    return mount;
}

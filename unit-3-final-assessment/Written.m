             ...
             withArrayTwo:(NSArray *)arrayTwo
{
    ...
    NSMutableArray *jointArray = [[NSMutableArray alloc] initWithArray:arrayOne];
    
    for (int i = 0; i < arrayTwo.count; i++) {
        [jointArray addObject:[arrayTwo objectAtIndex:i]];
    }
...
- (NSString *)returnTheLastStandardResolutionImageURL:(NSDictionary *)JSON
{
    ...
    NSString *lastObjectStandardImage = [data lastObject][@"images"][@"standard_resolution"][@"url"];
    
    return lastObjectStandardImage;
}
